...
#     seed = 42
#     prompt = "ultra-realistic product photo of a pair of modern running shoes on a white background, studio lighting, soft shadow under the shoes, detailed fabric texture, clean composition, high-end ecommerce photography"  # TODO: choisissez un prompt e-commerce en anglais unique et gardez-le identique pour tous les runs
...
def run_img2img_experiments() -> None:
    ...
    prompt = "ultra-realistic ecommerce product photo of white running shoes on a clean white background with studio lighting, soft shadow, sharp details, high-end catalog style"   # TODO: prompt e-commerce (en anglais)
    negative = "text, watermark, logo, low quality, blurry, deformed"
