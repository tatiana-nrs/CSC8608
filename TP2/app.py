...
prompt = st.text_area(
    "Prompt",
    value=(
        "ultra-realistic ecommerce product photo of a pair of modern running shoes on a clean white background, "
        "studio lighting, soft shadow, sharp details, high-end catalog style"
    ),
)
